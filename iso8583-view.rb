...
class IsoMessage < ISO8583::Message
  ...
  mti 600 , "Search Transaction"
  mti 610 , "Search Transaction Response"
  mti 800 , "Network Management Request"
  mti 810 , "Network Management Response"
  mti 9820 , "Network Management Response"
  mti 9830 , "Network Management Response"
...
#m = "008002238000100C1000890000101151410320004361110320115110000000194100000004000040000000000012007006000009014001008EL0107SC"
...
set = IsoMessage.new
if $0 == __FILE__
  set.iso_get_message(nil, nil, ARGV[0])
end
